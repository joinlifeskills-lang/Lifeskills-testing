...
import { mobileMoreItems } from "@/lib/teacher/navigation";
import { DollarSign, TrendingUp, User, Settings, X } from "lucide-react";
...
interface TeacherMobileSheetProps {
  open: boolean;
  onClose: () => void;
}

export default function TeacherMobileSheet({ open, onClose }: TeacherMobileSheetProps) {
